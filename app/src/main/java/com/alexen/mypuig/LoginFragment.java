...
public class LoginFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        emailEditText = view.findViewById(R.id.editTextUsuarioLogin);
        passwordEditText = view.findViewById(R.id.editTextContraseñaLogin);
        emailSignInButton = view.findViewById(R.id.buttonIniciarSesion);
        signInForm = view.findViewById(R.id.signInForm);
        googleSignInButton = view.findViewById(R.id.buttonIniciarSesionGoogle);

        view.findViewById(R.id.textViewCreaTuCuenta).setOnClickListener(new View.OnClickListener() {
            @Override
